          ...
          revealContent={
            <div style={{ height: '100%', width: '100%', padding: '1.5rem', background: 'transparent', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                <h3 style={{ margin: 0 }}>Integration Config</h3>
                <button 
            ...
            <div ref={scrollRef} style={{ position: 'relative', padding: isDesktop ? '2rem 3rem' : '1.5rem', paddingBottom: '3rem', background: '#121212', minHeight: '100%', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', flex: 1 }}>
                <div>
                  ...
                  <TextField placeholder="Billing Sync" />
                </div>
                
                <div>
                  <label style={{ color: 'white', display: 'block', marginBottom: '0.5rem', fontSize: '0.875rem' }}>Environment</label>
                  <RadioGroup 
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: '0.5rem' }}>
                  <span style={{ color: '#a1a1aa', fontSize: '0.875rem' }}>View Configuration</span>
                ...
                <div style={{ marginTop: '1rem' }}>
                  ...
                  <Timeline 
                    ...
                    data={[
                      { title: 'Create Account', content: <div className="text-zinc-400">Sign up for free</div> },
                      { title: 'Configure', content: <div className="text-zinc-400">Set up details</div> },
                      { title: 'Deploy', content: <div className="text-zinc-400">Go live</div> }
                    ]}
                  />
                </div>
              </div>
              ...
              <div style={{ marginTop: '1rem' }}>
                <Button variant="primary" style={{ width: '100%' }}>Create Integration</Button>
              </div>
            </div>
          }
        />
...
escaped_form_code = original_form_code.replace('`', '\\`').replace('$', '\\$')
...
const FORM_CODE = `__ESCAPED_FORM_CODE__`;
...
full_code = full_code.replace("__ESCAPED_FORM_CODE__", escaped_form_code)
